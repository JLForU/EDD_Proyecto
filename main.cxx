...
/* Implementación de funciones para la ejecución de comandos. */


void llenarMazo ( ) {

    mazo.push_back ( Carta ( "Alaska" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Alberta" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "América Central" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Estados Unidos Orientales" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Groenlandia" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Territorio Noroccidental" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Ontario" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Quebec" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Estados Unidos Occidentales" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Argentina" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Brasil" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Perú" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Venezuela" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Gran Bretaña" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Islandia" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Europa del Norte" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Escandinavia" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Europa del Sur" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Ucrania" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Europa Occidental" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Congo" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "África Oriental" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Egipto" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Madagascar" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "África del Norte" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "África del Sur" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Afghanistán" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "China" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "India" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Irkutsk" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Japón" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Kamchatka" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Medio Oriente" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Mongolia" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Siam" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Siberia" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Ural" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Yakutsk" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Australia Oriental" , "Artillería" ) ) ;
    mazo.push_back ( Carta ( "Indonesia" , "Infantería" ) ) ;
    mazo.push_back ( Carta ( "Nueva Guinea" , "Caballería" ) ) ;
    mazo.push_back ( Carta ( "Australia Occidental" , "Artillería" ) ) ;
